...
func (s *Server) defineRoutes(router *gin.Engine) {
	...
	apirouter.POST("/company", s.CreateCompany())
	apirouter.PATCH("/company", s.UpdateCompany())
	apirouter.DELETE("/company", s.DeleteCompany())
	apirouter.GET("/company", s.GetCompanyByName())
}
